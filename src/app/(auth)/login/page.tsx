...
function LoginForm() {
  ...
  return (
    <div className="flex-grow flex items-center justify-center py-16 px-6 relative overflow-hidden bg-slate-50 min-h-screen">
      {/* Background effects */}
      <div className="absolute top-1/4 left-1/3 h-[400px] w-[400px] rounded-full bg-indigo-500/5 blur-[120px] pointer-events-none" />
      <div className="absolute bottom-1/4 right-1/3 h-[300px] w-[300px] rounded-full bg-sky-500/5 blur-[100px] pointer-events-none" />
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-[200px] w-[200px] rounded-full bg-purple-500/3 blur-[80px] pointer-events-none" />
      ...
      <div className="w-full max-w-md space-y-8 relative z-10">
        ...
        <div className="text-center">
          ...
          <p className="text-sm text-slate-500 mt-2">
            Sign in to access your saved colleges, reviews, and dashboards.
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full glass-input pl-10 pr-4 py-3 text-sm rounded-xl"
                  autoComplete="email"
                />
              </div>
              {errors.email && (
            ...
            <div className="space-y-1.5">
              ...
              <div className="flex justify-end mt-1">
                <Link href="/forgot-password" className="text-[11px] text-indigo-600 hover:text-indigo-700 font-semibold">
                  Forgot password?
                </Link>
              </div>
            </div>
